...
public class Case5329TestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "case5329-functional-test-config.xml";
    }

    @Test
    public void case5329() throws Exception
    {
...
//        assertFalse(result.getPayload() instanceof NullPayload);
        ...
        assertEquals("http1", result.getPayloadAsString());
    }
}
