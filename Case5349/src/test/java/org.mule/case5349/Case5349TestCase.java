...
public class Case5349TestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "case5349-functional-test-config.xml";
    }

    @Test
    public void case5349() throws Exception
    {
