...
public class Case5345TestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "case5345-functional-test-config.xml";
    }

    @Test
    public void case5345() throws Exception
    {
